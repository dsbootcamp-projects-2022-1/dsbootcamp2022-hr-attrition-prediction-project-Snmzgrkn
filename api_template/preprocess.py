...
# TODO
COLUMNS_TO_REMOVE = ["EmployeeCount","EmployeeNumber","Over18"]
...
def create_features(df: pd.DataFrame) -> pd.DataFrame:
    ...
    cat_YearsCompany = pd.cut(df["YearsAtCompany"].to_list(),bins)
    cat_YearsCompany.categories=[0,1,2,3]
    df["YearsAtCompany"] = cat_YearsCompany
